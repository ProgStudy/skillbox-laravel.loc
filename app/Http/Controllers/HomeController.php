...
class HomeController extends Controller
{
    ...
    {
        $articles = Cache::tags(['articles'])->rememberForever('HomeController:index_' . request()->get('page', 1), function () {
    ...
    {
        $result = Cache::tags(['news', 'articles'])->rememberForever('HomeController:statistic', function () {
            $result = [
                [
    ...
    {
        $news = Cache::tags(['news'])->rememberForever('HomeController:news_' . request()->get('page', 1), function () {
